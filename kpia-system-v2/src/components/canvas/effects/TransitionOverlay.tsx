...
function TransitionPipeline({ active, durationSec = 6, onMidpoint, onComplete, tip }: { active: boolean; durationSec?: number; onMidpoint?: () => void; onComplete?: () => void; tip: string }) {
    ...
    const TEXT_START = MIDPOINT_TIME - 0.5;
    const TEXT_END = END_TIME - 0.5;
    const TIP_END = MIDPOINT_TIME + 1.5;
            ...
            <Html fullscreen style={{ pointerEvents: 'none' }}>
                <div className="w-full h-full flex flex-col items-center justify-center relative">
                    ...
                    <AnimatePresence>
                        ...
                        {pipelineState.current.time > TEXT_START && pipelineState.current.time < TEXT_END && (
                            <motion.div
                    ...
                    {/* Top Right Tips */}
                    <AnimatePresence>
                        {pipelineState.current.time > -0.5 && pipelineState.current.time < TIP_END && (
                            <motion.div
